...
class SumScreen extends React.Component{
 constructor() {
    super();
    this.state = {
      present_students: [],
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={{flex:0.1, flexDirection:'row', justifyContent:'space-around'}}>
         <Text style={{fontFamily: "Times New Roman"}}> Total: {} </Text>
         
          <Text style={{fontFamily: "Times New Roman"}} >Present: {this.state.present_students.length}</Text>
          <Text style={{fontFamily: "Times New Roman"}}>Absent: {this.state.absent_students.length}</Text>
